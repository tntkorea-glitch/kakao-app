    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-gray-900 rounded-2xl p-8 shadow-2xl">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 bg-white text-gray-900 hover:bg-gray-100 rounded-lg font-medium text-sm mb-6"
        >
